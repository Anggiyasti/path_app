                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="profile">
                                ...
                                <form class="panel form-horizontal form-bordered" name="form-profile" action="<?=base_url()?>index.php/admin/edit_admin" method="post">
                                    <div class="panel-body pt0 pb0">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 ">ID Admin</label>
                                            <div class="col-sm-5">
                                                <input class="form-control" name="id_admin" type="text" value="<?=$id_admin; ?>" disabled/>
