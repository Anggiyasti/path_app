                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-toolbar-wrapper pl0 pt5 pb5">
                                ...
                                <div class="panel-toolbar text-right">
                                   ...
                                   <form class="form-horizontal" action="<?=base_url()?>index.php/user/filterbab" method="post" id="d">
                                    <div class="has-icon">
                                   ...
                                   <div id="tes">
                                    <div class='form-group'>
                                        ...
                                        <div class="form-group">
                                        <input type='submit' id='hideshow' name="submit" value='Tampil'>
                                            <!-- <input type="submit" id="tampil" name="submit" value="Tampil"> -->
                                        </div>
                                        </div>
                                </form>
                                <!-- <div id='content'>Hello World</div>
<input type='button' id='hideshow' value='hide/show'>
                                <div id="c"><p>If you click on the "Hide" button, I will disappear.</p></div>
...
<form  class="panel panel-default form-horizontal form-bordered" action="<?=base_url()?>index.php/user/filterbab" method="post" >
       <div class='form-group'>
                                        <label>Mata Pelajaran</label>
                                        <select class='form-control' id='pelajaran'>
                                        <option value='0'>--pilih--</option>
...
$.ajaxSetup({
type:"POST",
url: "<?php echo base_url('index.php/user/ambil_data') ?>",
cache: false,
});
