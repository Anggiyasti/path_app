                            ...
                            <div class="table-responsive panel-collapse pull out">
                             <?php echo $this->session->flashdata('msg'); ?>
                                <table class="table table-bordered table-hover" id="table1">
                                    ...
                                    <a href="<?=base_url()?>index.php/user/edit_siswa/<?=$ds['id_siswa']?>" class="btn btn-outline btn-info">Edit</a> 
                                    <a class="btn btn-outline btn-info" href="#delete" data-toggle="modal" data-target="#delete<?php echo $ds['id_siswa'];?>">Hapus</a>
                                                               
                                                                <!-- Modal hapus-->
                            <div class="modal fade" id="delete<?php echo $ds['id_siswa']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a href="<?=base_url()?>index.php/user/hapus_siswa/<?=$ds['id_siswa']?>" class="btn btn-default" >Yes</a>
