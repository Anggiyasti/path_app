                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-toolbar-wrapper pl0 pt5 pb5">
                                ...
                                <div class="panel-toolbar text-right">
                                    ...
                                    <form class="form-horizontal" action="<?=base_url()?>index.php/user/cari" method="post">
                                    <div class="has-icon">
                                        <input type="text" class="form-control" name="id_mapel" placeholder="Search message..."> Hello  
                                        <i class="ico-search form-control-icon"></i>
                                    </div>
                                    <div class="col-sm-8">
                                    <label>Mapel</label>
