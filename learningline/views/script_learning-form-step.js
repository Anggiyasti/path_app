...
$('.lihat_step').click(function(){
	...
	var url = base_url+"index.php/learningline/ajax_list_ge_step/"+<?=$this->uri->segment(3)?>;
...
$('.simpan_step').click(function(){
	...
	var url = base_url+"index.php/learningline/ajax_insert_line_step/";
	var data;
	if (value==1) {
		data = {
...
function load_video(){
	...
	var url = base_url+"index.php/learningline/ajax_get_video/"+babID;
