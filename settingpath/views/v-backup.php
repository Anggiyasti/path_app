                        ...
                        <div class="panel-heading">
                         ...
                         <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select class='form-control' name="jmlh_soal1">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2">Jumlah Soal</label>
                                        <div class="col-sm-5">
                                            <select class='form-control' name="jmlh_soal2">
                                                <?php for ($i=5; $i <= 40 ; $i=$i+5) { ?>
                                                <option value='<?=$i;?>'><?=$i;?></option>
                                                <?php } ?>
                                            </select>
                            ...
                            <div class="form-horizontal">
                                 ...
                                 <div >
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2">Jumlah Soal</label>
                                        <div class="col-sm-5">
                                            <select class='form-control' name="jmlh_soal3">
                                                <?php for ($i=5; $i <= 40 ; $i=$i+5) { ?>
                                                <option value='<?=$i;?>'><?=$i;?></option>
                                                <?php } ?>
                                            </select>
                            ...
                            <div class="form-horizontal">
                             ...
                             <div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2">Jumlah Soal</label>
                                    <div class="col-sm-5">
                                        <select class='form-control' name="jmlh_soal4">
                                            <?php for ($i=5; $i <= 40 ; $i=$i+5) { ?>
                                            <option value='<?=$i;?>'><?=$i;?></option>
                                            <?php } ?>
                                        </select>
                            ...
                            <div class="form-horizontal">
                                 ...
                                 <div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2">Jumlah Soal</label>
                                        <div class="col-sm-5">
                                            <select class='form-control' name="jmlh_soal5">
                                                <?php for ($i=5; $i <= 40 ; $i=$i+5) { ?>
                                                <option value='<?=$i;?>'><?=$i;?></option>
                                                <?php } ?>
                                            </select>
