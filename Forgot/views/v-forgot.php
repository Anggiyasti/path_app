            ...
            <div class="login-block" style="min-width: 50%">
                ...
                <div class="">
                    ...
                    <div class="page-header-section">
                        ...
                        <h4 class="title font-alt text-center">LUPA PASSWORD LAGI</h4>
               ...
               <!--  <form class="login-form" name="form-register" action="<?= base_url() ?>index.php/forgot/cobalagiah" method="post"> -->
