                        ...
                        <div class="courses-box1"  style="text-align: center;">
                            <div class="single-item-wrapper" style="height: 200px;">
                                <div class="courses-img-wrapper hvr-bounce-to-bottom" >
                                    ...
                                    <a href="<?=base_url()?>index.php/grafikreport/pilih_bab_report/<?=$mapelitem['nama_mapel'] ?>"><i class="fa fa-link" aria-hidden="true"></i></a>
                                </div>
                                <div class="courses-content-wrapper" >
                                    <h3 class="item-title"><a href="<?=base_url()?>index.php/grafikreport/pilih_bab_report/<?=$mapelitem['nama_mapel'] ?>"><?=$mapelitem['nama_mapel'] ?></a></h3>
                                </div>                            
                            </div>                            
                        </div>
                        <?php endforeach ?>                      
