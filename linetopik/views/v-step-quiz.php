                                    ...
                                    <div class="panel-collapse">
                                        <div class="panel-body">
                                                ...
                                                <div class="col-md-12" style="">
                                                    <hr> 
                                                    <button type="button" class="default-full-width-btn" align="center" style="background-color: #002147;" onclick="kirimHasil();deleteAllCookies('seconds', 'minutes', 'hours');">Kumpulkan Jawaban</button>
                                                </div>
                                        </div>
                                        <div></div> 
                                        <!--/ panel body with collapse capabale--> 
