            ...
            <div class="courses1-area">
                <div class="container">    
                    <h2 class="title-default-left">Path - Mata Pelajaran</h2> 
                </div>
                        ...
                        <div class="courses-box1">
                            <div class="single-item-wrapper">
                                ...
                                <div class="courses-content-wrapper">
                                    <h3 class="item-title"><a href="<?=base_url()?>index.php/linetopik/pilih_bab_report/<?=$mapelitem['nama_mapel'] ?>"><?=$mapelitem['nama_mapel'] ?></a></h3>
                                </div>                            
                            </div>                            
                        </div>
                        <?php endforeach ?>                      
