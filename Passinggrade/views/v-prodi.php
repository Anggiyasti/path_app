        ...
        <?php foreach ($data as $univ) : ?>
            <div class="dropdown-menu">
                ...
                <div class="dropdown-content bg-red-light">
                    <a href="#" class="dropdown-item"><i class="ion-ios-book-outline"></i><em><?=$univ['prodi']?></em><i class="ion-ios-arrow-thin-right"></i></a>
                    <a href="#" class="dropdown-item"><i class="ion-ios-book-outline"></i><em><?=$univ['passinggrade']?>%</em><i class="ion-ios-arrow-thin-right"></i></a>
                </div>
            </div>
           <?php endforeach ?>                             
        </div> 
