          ...
          <div class="card m-t-40 animated fadeinup delay-2">
            <div class="c-widget">
              ...
              <div class="c-widget-body">
                <p class="m-0"><a href="<?=base_url()?>index.php/passinggrade/hasilpassing/<?=$no1;?>">21%-25%</a></p>
              </div>
           ...
           <div class="card m-t-40 animated fadeinup delay-2">
            <div class="c-widget">
              ...
              <div class="c-widget-body">
                <p class="m-0"><a href="<?=base_url()?>index.php/passinggrade/hasilpassing/<?=$no2;?>">26%-30%</a></p>
              </div>
