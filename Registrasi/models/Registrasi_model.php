...
class Registrasi_model extends CI_Model
{
	...
	function __construct()
		...
		public function sendEmail($to_email)
		{
			...
			$message = 'Dear Student Lovers,<br /><br />Please click on the below activation link to verify your email address.<br /><br /> http://localhost:81/path/index.php/user/verify/' . md5($to_email) . '<br /><br /><br />Thanks<br />Path Team';
