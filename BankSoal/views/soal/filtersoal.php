            ...
            <section class="content slimscroll">
                ...
                <ul class="topmenu topmenu-responsive" data-toggle="menu">
                    ...
                    <li class="active open">
                        ...
                        <!-- START 2nd Level Menu -->
                        <ul id="soal" class="submenu collapse in">
                            <li class="submenu-header ellipsis">Forms</li>
                            <li class="active">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" action="<?=base_url()?>index.php/Banksoal/filtersoal" method="post">
                                    <div class="has-icon">
                            ...
                            <div class="table-responsive panel-collapse pull out">
                                <table class="table table-bordered table-hover" id="table1">
                                    ...
                                    <a class="btn btn-outline btn-info" href="#delete" data-toggle="modal" data-target="#delete<?php echo $ds['id_bank']?>">Hapus</a>
