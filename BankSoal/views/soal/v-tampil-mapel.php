                ...
                <ul class="topmenu topmenu-responsive" data-toggle="menu">
                    ...
                    <li class="active open">
                        ...
                        <ul id="form" class="submenu collapse in">
                            ...
                            <li >
                                <a href="<?php echo base_url('index.php/banksoal/tambahkategori')?>">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-toolbar-wrapper pl0 pt5 pb5">
                                ...
                                <div class="panel-toolbar text-right">
                                    <!-- <div class="col-sm-3">
                                        <select name="kesulitan" id="kesulitan" class="form-control" value="<?php echo $editdata->kesulitan; ?>">
                                            <option value="1">Mudah</option>
                                            <option value="2">Sedang</option>
                                        </select>
                                    </div> -->
                                    <form class="form-horizontal" action="<?=base_url()?>index.php/Banksoal/search" method="post">
                                    <div class="has-icon">
                                        <input type="text" class="form-control" name="id_mapel" placeholder="Search message...">
                                        <i class="ico-search form-control-icon"></i>
                                    </div>
                                </form>
                                    </div>
                            ...
                            <div class="table-responsive panel-collapse pull out">
                                <table class="table table-bordered table-hover" id="table1">
                                    ...
                                    <a href="<?=base_url()?>index.php/banksoal/edit_mapel/<?=$ds['id_mapel']?>" class="btn btn-outline btn-info">Edit</a> 
                                    <a class="btn btn-outline btn-info" href="#deletemapel" data-toggle="modal" data-target="#deletemapel<?php echo $ds['id_mapel']?>">Hapus</a>
                            ...
                            <div class="table-responsive panel-collapse pull out">
                                <table class="table table-bordered table-hover" id="table1">
                                    ...
                                    <a href="<?=base_url()?>index.php/banksoal/ubah_bab/<?=$ds['id_bab']?>" class="btn btn-outline btn-info">Edit</a> 
                                    <a class="btn btn-outline btn-info" href="#delete" data-toggle="modal" data-target="#delete<?php echo $ds['id_bab']?>">Hapus</a>
                                                                <div class="modal fade" id="delete<?php echo $ds['id_bab']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                        ...
                                        <div class="modal-footer">
                                            <a href="<?=base_url()?>index.php/banksoal/hapus_bab/<?=$ds['id_bab']?>" class="btn btn-default" >Yes</a>
                                            <a href="#"class="btn btn-default" data-dismiss="modal">No</a>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
