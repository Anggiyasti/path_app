                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <?php echo $this->session->flashdata('msg'); ?>
                                <form class="form-horizontal form-bordered" action="<?=base_url()?>index.php/user/tambah_guru" method="post">
                                    
                                   
                                    <div class="form-group">
                                        <label class="col-sm-2">Nama</label>
                                        <div class="col-sm-5">
                                            <input class="form-control" name="nama" placeholder="Nama Guru" type="text" value="<?php echo set_value('nama'); ?>" />
