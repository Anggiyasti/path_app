                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <?php echo $this->session->flashdata('msg'); ?>
                                <form class="form-horizontal form-bordered" action="<?=base_url()?>index.php/user/edit_siswa" method="post">
                                    <div class="form-group">
                                        <label class="col-sm-2">ID Siswa</label>
                                        <div class="col-sm-5">
                                            <input class="form-control" name="id_siswa" placeholder="Nama Depan" type="text" value="<?php echo $editdata->id_siswa; ?>" disabled />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input class="form-control" name="nama_depan" placeholder="Nama Depan" type="text" value="<?php echo $editdata->nama_depan; ?>" />
                                            <span class="text-danger"><?php echo form_error('nama_depan'); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="nama_belakang" class="form-control" value="<?php echo $editdata->nama_belakang; ?>" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <textarea name="alamat" class="form-control" rows="2" value="<?php echo $editdata->alamat; ?>" ></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="no_tlp" class="form-control" value="<?php echo $editdata->no_tlp; ?>" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="nama_sekolah" class="form-control" value="<?php echo $editdata->nama_sekolah; ?>" >
                             ...
                             ?>
                                    ...
                                    <div class="panel-footer">
                                        <div class="form-group no-border">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="hidden" name="id_siswa" value="<?php echo $editdata->id_siswa;?>">
