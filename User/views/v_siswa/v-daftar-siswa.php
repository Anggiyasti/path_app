 ...
 <div class="container-fluid">
                ...
                <div class="page-header page-header-block">
                    <div class="checkbox custom-checkbox pull-left">  
                        <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-table22"></i></span> Daftar Siswa</h3>
                    </div>
                ...
                <div class="table-responsive">
                    ...
                    <div class="table-responsive panel-collapse pull out">
                            ...
                            <label for="customcheckbox-one1"></label>   
                             ...
                             ?></td> 
                                            <td><a class='label label-info' href='<?=base_url()?>index.php/siswa/reportSiswa/<?=$ds['email'] ?>' title='lihat detail' data-toggle='modal' data-target=''>Lihat Detail</a></td>                    
