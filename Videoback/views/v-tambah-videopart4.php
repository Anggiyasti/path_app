...
<!--                     <div class="col-md-6">
 -->                        <!-- Form horizontal layout striped -->
                        <form class="form-horizontal form-striped panel panel-default" action="<?=base_url()?>index.php/videoback/cek_option_upload_part4" method="post" accept-charset="utf-8" enctype="multipart/form-data">
