                ...
                <div class="table-responsive">
                    ...
                    <tr>
                        ...
                        <div class="toolbar">
                            <!-- btn-group -->
                           <div class="btn-group">                                            
                                <a href="<?=base_url()?>index.php/videoback/edit_video/<?=$d['id_video']?>" class="btn btn-outline btn-info">Edit</a> 
                                <a class="btn btn-outline btn-info" href="#delete" data-toggle="modal" data-target="#delete<?php echo $d['id_video'];?>">Hapus</a>              
                            </div>
                            <!--/ btn-group -->
                        </div>
                         <div class="modal fade" id="delete<?php echo $d['id_video'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="<?=base_url()?>index.php/videoback/del_file_video/<?=$d['id_video']?>" class="btn btn-default" >Yes</a>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        tb_allSoal = $('#tb_allSoal').DataTable({ 
           "ajax": {
                    "url": base_url+"index.php/Banksoal/detailSoal",
                    "type": "POST"
                    },
            "processing": true,
        });
    ...
    function detailSoal(id_bank) {
        var kelas ='.detail-'+id_bank;
        var data = $(kelas).data('id');
        var jawaban=$('#jawaban-'+id_bank).val();
